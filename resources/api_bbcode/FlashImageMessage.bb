[font_size=30][color=#70bafa]类:[/color] FlashImageMessage[/font_size]
...
[font_size=30][color=#70bafa]方法:[/color][/font_size]
	...
	● [color=gray]static[/color] [color=#70bafa]FlashImageMessage[/color] init [color=gray]([/color] [color=#70bafa]Image[/color] image [color=gray])[/color]

	基于图像实例缓存并手动构造一个FlashImageMessage类的实例


	● [color=gray]static[/color] [color=#70bafa]FlashImageMessage[/color] init_gif [color=gray]([/color] [color=#70bafa]GifImage[/color] gif_image [color=gray])[/color]

	基于Gif动图实例缓存并手动构造一个FlashImageMessage类的实例


	● [color=gray]static[/color] [color=#70bafa]FlashImageMessage[/color] init_id [color=gray]([/color] [color=#70bafa]String[/color] image_id [color=gray])[/color]

	基于指定的图像ID来手动构造一个FlashImageMessage类的实例


	● [color=gray]static[/color] [color=#70bafa]FlashImageMessage[/color] init_url [color=gray]([/color] [color=#70bafa]String[/color] image_url [color=gray])[/color]

	基于指定的URL地址来手动构造一个FlashImageMessage类的实例


	● [color=gray]static[/color] [color=#70bafa]FlashImageMessage[/color] init_path [color=gray]([/color] [color=#70bafa]String[/color] image_path [color=gray])[/color]

	基于指定的本地文件路径来手动构造一个FlashImageMessage类的实例


	● [color=gray]static[/color] [color=#70bafa]FlashImageMessage[/color] init_base64 [color=gray]([/color] [color=#70bafa]String[/color] image_base64 [color=gray])[/color]

	基于指定的BASE64编码来手动构造一个FlashImageMessage类的实例


	● [color=gray]static[/color] [color=#70bafa]FlashImageMessage[/color] init_meta [color=gray]([/color] [color=#70bafa]Dictionary[/color] dic [color=gray])[/color]
