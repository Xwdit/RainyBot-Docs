[font_size=30][color=#70bafa]类:[/color] MemberUnmuteEvent[/font_size]
...
[font_size=30][color=#70bafa]方法:[/color][/font_size]
	...
	● [color=gray]static[/color] [color=#70bafa]MemberUnmuteEvent[/color] ￿init_meta [color=gray]([/color] [color=#70bafa]Dictionary[/color] dic [color=gray])[/color]
