[font_size=30][color=#70bafa]类:[/color] Message[/font_size]

[color=#70bafa]继承自:[/color] MessageAPI
 
[color=#70bafa]子类:[/color] AppMessage, AtAllMessage, AtMessage, BotCodeMessage, DiceMessage, FaceMessage, FileMessage, FlashImageMessage, ForwardMessage, ImageMessage, JsonMessage, MarketFaceMessage, MusicShareMessage, PokeMessage, QuoteMessage, SourceMessage, TextMessage, VoiceMessage, XmlMessage
