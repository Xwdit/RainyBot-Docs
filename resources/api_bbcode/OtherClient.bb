...
[font_size=25][color=#70bafa][b]方法[/b][/color][/font_size]
	...
	● [color=gray]static[/color] [color=#70bafa][url=api:OtherClient]OtherClient[/url][/color] ￿init￿ [color=gray]([/color] [color=gray])[/color]

	手动构造一个OtherClient类的实例，用于主动进行与其他客户端的交互时使用


	● [color=gray]static[/color] [color=#70bafa][url=api:OtherClient]OtherClient[/url][/color] ￿init_meta￿ [color=gray]([/color] [color=#70bafa][url=godot:Dictionary]Dictionary[/url][/color] dic [color=gray])[/color]
	...
	● [color=#70bafa][url=godot:String]String[/url][/color] ￿get_platform￿ [color=gray]([/color] [color=gray])[/color]
