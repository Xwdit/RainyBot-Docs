...
[font_size=25][color=#70bafa][b]方法[/b][/color][/font_size]
	...
	● [color=gray]static[/color] [color=#70bafa][url=api:MemberProfile]MemberProfile[/url][/color] ￿init_user￿ [color=gray]([/color] [color=#70bafa][url=godot:int]int[/url][/color] user_id, [color=#70bafa][url=godot:float]float[/url][/color] timeout[color=gray] = inf_neg[/color] [color=gray])[/color]
	...
	● [color=gray]static[/color] [color=#70bafa][url=api:MemberProfile]MemberProfile[/url][/color] ￿init_meta￿ [color=gray]([/color] [color=#70bafa][url=godot:Dictionary]Dictionary[/url][/color] dic [color=gray])[/color]
