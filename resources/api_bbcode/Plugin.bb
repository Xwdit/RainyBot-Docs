...
[font_size=30][color=#70bafa]方法:[/color][/font_size]
	...
	● [color=gray]void[/color] ￿set_plugin_info [color=gray]([/color] [color=#70bafa]String[/color] p_id, [color=#70bafa]String[/color] p_name, [color=#70bafa]String[/color] p_author, [color=#70bafa]String[/color] p_version, [color=#70bafa]String[/color] p_description, [color=#70bafa]Variant[/color] p_dependency[color=gray] = null[/color] [color=gray])[/color]
	...
	● [color=gray]static[/color] [color=#70bafa]Plugin[/color] ￿get_plugin_instance [color=gray]([/color] [color=#70bafa]String[/color] plugin_id [color=gray])[/color]
	...
	● [color=gray]void[/color] ￿register_event [color=gray]([/color] [color=#70bafa]Variant[/color] event, [color=#70bafa]Variant[/color] function, [color=#70bafa]int[/color] priority[color=gray] = 0[/color], [color=#70bafa]int[/color] block_mode[color=gray] = 3[/color] [color=gray])[/color]
	...
	● [color=gray]void[/color] ￿unregister_event [color=gray]([/color] [color=#70bafa]Variant[/color] event [color=gray])[/color]
	...
	● [color=gray]void[/color] ￿register_console_command [color=gray]([/color] [color=#70bafa]Variant[/color] command, [color=#70bafa]Variant[/color] function, [color=#70bafa]bool[/color] need_arguments[color=gray] = false[/color], [color=#70bafa]Array[/color] usages[color=gray] = [][/color], [color=#70bafa]bool[/color] need_connect[color=gray] = false[/color] [color=gray])[/color]
	...
	● [color=gray]void[/color] ￿unregister_console_command [color=gray]([/color] [color=#70bafa]Variant[/color] command [color=gray])[/color]
	...
	● [color=gray]void[/color] ￿register_keyword [color=gray]([/color] [color=#70bafa]Variant[/color] keyword, [color=#70bafa]Variant[/color] function, [color=#70bafa]Dictionary[/color] var_dic[color=gray] = {}[/color], [color=#70bafa]int[/color] match_mode[color=gray] = 0[/color], [color=#70bafa]bool[/color] block[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=gray]void[/color] ￿unregister_keyword [color=gray]([/color] [color=#70bafa]Variant[/color] keyword [color=gray])[/color]
	...
	● [color=#70bafa]bool[/color] ￿trigger_keyword [color=gray]([/color] [color=#70bafa]Event[/color] event [color=gray])[/color]
	...
	● [color=#70bafa]int[/color] ￿init_plugin_config [color=gray]([/color] [color=#70bafa]Dictionary[/color] default_config, [color=#70bafa]Dictionary[/color] config_description[color=gray] = {}[/color] [color=gray])[/color]
	...
	● [color=#70bafa]Variant[/color] ￿get_plugin_config [color=gray]([/color] [color=#70bafa]Variant[/color] key [color=gray])[/color]

	用于从已加载的配置中获取指定key对应的内容，需要先初始化配置文件才能使用此函数


	● [color=#70bafa]bool[/color] ￿has_plugin_config [color=gray]([/color] [color=#70bafa]Variant[/color] key [color=gray])[/color]

	用于从已加载的配置中检查指定key是否存在，需要先初始化配置文件才能使用此函数


	● [color=#70bafa]int[/color] ￿set_plugin_config [color=gray]([/color] [color=#70bafa]Variant[/color] key, [color=#70bafa]Variant[/color] value, [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]int[/color] ￿reset_plugin_config [color=gray]([/color] [color=#70bafa]Variant[/color] key, [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]int[/color] ￿reset_all_plugin_config [color=gray]([/color] [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]int[/color] ￿set_plugin_config_metadata [color=gray]([/color] [color=#70bafa]Dictionary[/color] dic, [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]int[/color] ￿set_plugin_data_metadata [color=gray]([/color] [color=#70bafa]Dictionary[/color] dic, [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]int[/color] ￿set_plugin_cache_metadata [color=gray]([/color] [color=#70bafa]Dictionary[/color] dic, [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]Variant[/color] ￿get_plugin_data [color=gray]([/color] [color=#70bafa]Variant[/color] key [color=gray])[/color]

	用于从已加载的数据库中获取指定key对应的内容，需要先初始化数据库文件才能使用此函数


	● [color=#70bafa]bool[/color] ￿has_plugin_data [color=gray]([/color] [color=#70bafa]Variant[/color] key [color=gray])[/color]

	用于从已加载的数据库中检查指定key是否存在，需要先初始化数据库文件才能使用此函数


	● [color=#70bafa]int[/color] ￿set_plugin_data [color=gray]([/color] [color=#70bafa]Variant[/color] key, [color=#70bafa]Variant[/color] value, [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]int[/color] ￿remove_plugin_data [color=gray]([/color] [color=#70bafa]Variant[/color] key, [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]int[/color] ￿clear_plugin_data [color=gray]([/color] [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]Variant[/color] ￿get_plugin_cache [color=gray]([/color] [color=#70bafa]Variant[/color] key [color=gray])[/color]

	用于从已加载的缓存数据库中获取指定key对应的内容，需要先初始化缓存数据库文件才能使用此函数


	● [color=#70bafa]bool[/color] ￿has_plugin_cache [color=gray]([/color] [color=#70bafa]Variant[/color] key [color=gray])[/color]

	用于从已加载的缓存数据库中检查指定key是否存在，需要先初始化缓存数据库文件才能使用此函数


	● [color=#70bafa]int[/color] ￿set_plugin_cache [color=gray]([/color] [color=#70bafa]Variant[/color] key, [color=#70bafa]Variant[/color] value, [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]int[/color] ￿remove_plugin_cache [color=gray]([/color] [color=#70bafa]Variant[/color] key, [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]int[/color] ￿clear_plugin_cache [color=gray]([/color] [color=#70bafa]bool[/color] save_file[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]Node[/color] ￿load_scene [color=gray]([/color] [color=#70bafa]String[/color] path, [color=#70bafa]bool[/color] for_capture[color=gray] = false[/color] [color=gray])[/color]
	...
	需要的参数从左到右分别为: 
	- 场景文件的路径，可以是相对路径(以[code]res://[/code]开头)，也可以是绝对路径(如D:/RaintBot/plugins，可通过[method get_plugin_path]函数来获取插件目录的绝对路径) 
	...
	● [color=#70bafa]Image[/color] ￿get_scene_image [color=gray]([/color] [color=#70bafa]Node[/color] scene, [color=#70bafa]Vector2i[/color] size, [color=#70bafa]Vector2i[/color] stretch_size[color=gray] = Vector2i(0, 0)[/color], [color=#70bafa]bool[/color] transparent[color=gray] = false[/color] [color=gray])[/color]
	...
	● [color=#70bafa]Variant[/color] ￿wait_context_custom [color=gray]([/color] [color=#70bafa]GDScript[/color] event_type, [color=#70bafa]int[/color] sender_id[color=gray] = -1[/color], [color=#70bafa]int[/color] group_id[color=gray] = -1[/color], [color=#70bafa]float[/color] timeout[color=gray] = 20.0[/color], [color=#70bafa]bool[/color] block[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]Variant[/color] ￿wait_context [color=gray]([/color] [color=#70bafa]MessageEvent[/color] event, [color=#70bafa]bool[/color] match_sender[color=gray] = true[/color], [color=#70bafa]bool[/color] match_group[color=gray] = true[/color], [color=#70bafa]float[/color] timeout[color=gray] = 20.0[/color], [color=#70bafa]bool[/color] block[color=gray] = true[/color] [color=gray])[/color]
	...
	● [color=#70bafa]Variant[/color] ￿wait_context_id [color=gray]([/color] [color=#70bafa]String[/color] context_id, [color=#70bafa]float[/color] timeout[color=gray] = 20.0[/color] [color=gray])[/color]
	...
	● [color=#70bafa]bool[/color] ￿respond_context [color=gray]([/color] [color=#70bafa]Variant[/color] context, [color=#70bafa]Variant[/color] response[color=gray] = true[/color] [color=gray])[/color]
