...
方法:
	...
	void set_plugin_info ( String p_id, String p_name, String p_author, String p_version, String p_description, Variant p_dependency=null )
	...
	static int get_global_runtime ( )

	用于获取RainyBot全局的已运行时间，默认情况下为RainyBot成功启动以来经过的秒数


	static Plugin get_plugin_instance ( String plugin_id )
	...
	static PackedStringArray get_last_errors ( )
	...
	void register_console_command ( Variant command, Variant function, bool need_arguments=false, Array usages=[], bool need_connect=false )
	...
	int reset_plugin_config ( Variant key, bool save_file=true )
	...
	int reset_all_plugin_config ( bool save_file=true )
