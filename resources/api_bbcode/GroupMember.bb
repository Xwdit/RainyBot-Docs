...
[font_size=25][color=#70bafa][b]方法[/b][/color][/font_size]
	...
	● [color=#70bafa][url=godot:String]String[/url][/color] ￿get_special_title￿ [color=gray]([/color] [color=gray])[/color]

	获取群成员实例在群聊中的特别称号(群荣誉)，若为手动构造的实例，将始终返回空字符串


	● [color=#70bafa][url=godot:int]int[/url][/color] ￿get_permission￿ [color=gray]([/color] [color=gray])[/color]
	...
	● [color=#70bafa][url=godot:bool]bool[/url][/color] ￿is_permission￿ [color=gray]([/color] [color=#70bafa][url=godot:int]int[/url][/color] perm [color=gray])[/color]

	判断群成员实例的类型是否为指定的类型


	● [color=#70bafa][url=godot:int]int[/url][/color] ￿get_join_timestamp￿ [color=gray]([/color] [color=gray])[/color]

	获取群成员实例加入其所在群聊的时间戳，若为手动构造的实例，将始终返回0


	● [color=#70bafa][url=godot:int]int[/url][/color] ￿get_last_speak_timestamp￿ [color=gray]([/color] [color=gray])[/color]

	获取群成员实例在对应群聊中上次发言的时间戳，若为手动构造的实例，将始终返回0


	● [color=#70bafa][url=godot:int]int[/url][/color] ￿get_mute_time_remaining￿ [color=gray]([/color] [color=gray])[/color]
	...
	● [color=#70bafa][url=api:BotRequestResult]BotRequestResult[/url][/color] ￿change_name￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] new_name, [color=#70bafa][url=godot:float]float[/url][/color] timeout[color=gray] = inf_neg[/color] [color=gray])[/color]
	...
	● [color=#70bafa][url=api:BotRequestResult]BotRequestResult[/url][/color] ￿change_special_title￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] new_title, [color=#70bafa][url=godot:float]float[/url][/color] timeout[color=gray] = inf_neg[/color] [color=gray])[/color]
	...
	● [color=#70bafa][url=api:BotRequestResult]BotRequestResult[/url][/color] ￿toggle_admin￿ [color=gray]([/color] [color=#70bafa][url=godot:bool]bool[/url][/color] enabled, [color=#70bafa][url=godot:float]float[/url][/color] timeout[color=gray] = inf_neg[/color] [color=gray])[/color]
	...
	● [color=#70bafa][url=api:BotRequestResult]BotRequestResult[/url][/color] ￿kick￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] message[color=gray] = ""[/color], [color=#70bafa][url=godot:float]float[/url][/color] timeout[color=gray] = inf_neg[/color] [color=gray])[/color]
	...
	● [color=#70bafa][url=api:BotRequestResult]BotRequestResult[/url][/color] ￿mute￿ [color=gray]([/color] [color=#70bafa][url=godot:int]int[/url][/color] time[color=gray] = 1800[/color], [color=#70bafa][url=godot:float]float[/url][/color] timeout[color=gray] = inf_neg[/color] [color=gray])[/color]
	...
	● [color=#70bafa][url=api:BotRequestResult]BotRequestResult[/url][/color] ￿unmute￿ [color=gray]([/color] [color=#70bafa][url=godot:float]float[/url][/color] timeout[color=gray] = inf_neg[/color] [color=gray])[/color]
