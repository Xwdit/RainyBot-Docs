...
[font_size=25][color=#70bafa][b]方法[/b][/color][/font_size]
	...
	● [color=gray]static[/color] [color=#70bafa][url=api:BotCodeMessage]BotCodeMessage[/url][/color] ￿init￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] text [color=gray])[/color]

	基于包含BotCode的文本来构造BotCodeMessage的实例，以便快捷发送复杂消息


	● [color=gray]static[/color] [color=#70bafa][url=api:BotCodeMessage]BotCodeMessage[/url][/color] ￿init_meta￿ [color=gray]([/color] [color=#70bafa][url=godot:Dictionary]Dictionary[/url][/color] dic [color=gray])[/color]
	...
	● [color=gray][hint=此函数无返回值]void[/hint][/color] ￿set_code_text￿ [color=gray]([/color] [color=#70bafa][url=godot:String]String[/url][/color] text [color=gray])[/color]
