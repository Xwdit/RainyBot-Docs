...
[font_size=25][color=#70bafa][b]方法[/b][/color][/font_size]
	...
	● [color=#70bafa][url=api:MessageChain]MessageChain[/url][/color] ￿append￿ [color=gray]([/color] [color=#70bafa][url=godot:Variant]Variant[/url][/color] msg [color=gray])[/color]
	...
	● [color=#70bafa][url=api:Message]Message[/url][/color] ￿get_message￿ [color=gray]([/color] [color=#70bafa][url=godot:int]int[/url][/color] index [color=gray])[/color]
	...
	● [color=#70bafa][url=godot:bool]bool[/url][/color] ￿has_message_type￿ [color=gray]([/color] [color=#70bafa][url=godot:Variant]Variant[/url][/color] type [color=gray])[/color]
