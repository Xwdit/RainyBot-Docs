...
* 请将 [Mirai](https://github.com/mamoe/mirai) 与 [Mirai-Console](https://github.com/mamoe/mirai-console) 的`v2.14.0`版Jar文件及相关依赖文件置于\_与Godot编辑器可执行文件同目录下\_的`adapters/mirai/libs`路径中
* 请将 [Mirai-Api-HTTP](https://github.com/project-mirai/mirai-api-http) 的`v2.9.1`版Jar文件置于\_与Godot编辑器可执行文件同目录下\_的`adapters/mirai/plugins`路径中
